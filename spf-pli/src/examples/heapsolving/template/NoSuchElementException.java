...
/**
 * Thrown by the <code>nextElement</code> method of an <code>Enumeration</code>
 * to indicate that there are no more elements in the enumeration.
 *
 * @author unascribed
 * @version 1.20, 01/23/03
 * @see examples.java2.util2.Enumeration
 * @see examples.java2.util2.Enumeration#nextElement()
 * @since JDK1.0
 */
public class NoSuchElementException extends RuntimeException {
    ...
    /**
     * Constructs a <code>NoSuchElementException</code>, saving a reference to the
