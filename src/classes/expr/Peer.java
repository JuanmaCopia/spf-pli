...
public class Peer {
    ...
    // expr eval
    native public static void countFalsePositive();

    native public static void countFalseNegative();

    native public static void countTruePositive();

    native public static void countTrueNegative();
