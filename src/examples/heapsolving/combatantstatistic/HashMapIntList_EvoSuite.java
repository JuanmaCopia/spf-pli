 ...
 * @since 1.2
 */
public class HashMapIntList_EvoSuite {
    /**
     ...
     */
    public HashMapIntList_EvoSuite() {
...
//    }
         ...
         */
        void recordAccess(HashMapIntList_EvoSuite m) {
        }

        /**
         * This method is invoked whenever the entry is removed from the table.
         */
        void recordRemoval(HashMapIntList_EvoSuite m) {
        }
    }
