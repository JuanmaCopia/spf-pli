...
public class HashMap_EvoSuite {
     ...
     */
    protected final int MAXIMUM_CAPACITY = 1 << 30;
    ...
    public static class Entry {
         ...
         */
        void recordAccess(HashMap_EvoSuite m) {
        }

        /**
         * This method is invoked whenever the entry is removed from the table.
         */
        void recordRemoval(HashMap_EvoSuite m) {
        }
    }
