 ...
 * @since 1.2
 */
public class HashMapStr_EvoSuite {
    /**
     ...
     * readObject.
     */
    void createEntry(int hash, int key, String value, int bucketIndex) {
        setTable(bucketIndex, new Entry(hash, key, value, getTable(bucketIndex)));
        size++;
    }
    ...
    public static class Entry {
         ...
         */
        void recordAccess(HashMapStr_EvoSuite m) {
        }

        /**
         * This method is invoked whenever the entry is removed from the table.
         */
        void recordRemoval(HashMapStr_EvoSuite m) {
        }
    }
