 ...
 * @since 1.2
 */
public class HashMapHMap_EvoSuite {
    /**
     ...
     */
    public HashMapStr_EvoSuite get(int key) {
        int hash = hash(key);
     ...
     *         the specified key.
     */
    public HashMapStr_EvoSuite put(int key, HashMapStr_EvoSuite value) {
        int hash = hash(key);
        int i = indexFor(hash, DEFAULT_INITIAL_CAPACITY);

        for (Entry e = getTable(i); e != null; e = e.next) {
            if (e.hash == hash && eq(key, e.key)) {
                HashMapStr_EvoSuite oldValue = e.value;
                e.value = value;
                e.recordAccess(this);
                return oldValue;
            }
     ...
     *         specified key.
     */
    public HashMapStr_EvoSuite remove(int key) {
     ...
     */
    void addEntry(int hash, int key, HashMapStr_EvoSuite value, int bucketIndex) {
     ...
     * readObject.
     */
    void createEntry(int hash, int key, HashMapStr_EvoSuite value, int bucketIndex) {
        setTable(bucketIndex, new Entry(hash, key, value, getTable(bucketIndex)));
        size++;
    }
    ...
    public boolean repOKSymSolve() {
        ...
        Set<HashMapStr_EvoSuite> v2 = new HashSet<>();
        for (Entry e : visited) {
            if (e != null) {
                HashMapStr_EvoSuite value = e.getValue();
        ...
        Set<HashMapStr_EvoSuite.Entry> v3 = new HashSet<>();
        for (HashMapStr_EvoSuite h : v2) {
    ...
    public boolean repOKSymbolicExecution() {
        List<HashMapStr_EvoSuite> hm = new LinkedList<>();
        for (int i = 0; i < DEFAULT_INITIAL_CAPACITY; i++) {
            Entry list = getTable(i);
        ...
        for (HashMapStr_EvoSuite value : hm) {
    ...
    private boolean checkListKeys(Entry head, int index, List<HashMapStr_EvoSuite> hm) {
    ...
    public static class Entry {
        ...
        public int key;
        public HashMapStr_EvoSuite value;
        public int hash;
        public Entry next;
         ...
         * Create new entry.
         */
        Entry(int h, int k, HashMapStr_EvoSuite v, Entry n) {
            value = v;
            next = n;
            key = k;
            hash = h;
        ...
        public HashMapStr_EvoSuite getValue() {
            return value;
        }

        public HashMapStr_EvoSuite setValue(HashMapStr_EvoSuite newValue) {
            HashMapStr_EvoSuite oldValue = value;
            value = newValue;
            return oldValue;
        }
         ...
         */
        void recordAccess(HashMapHMap_EvoSuite m) {
        }

        /**
         * This method is invoked whenever the entry is removed from the table.
         */
        void recordRemoval(HashMapHMap_EvoSuite m) {
        }
    }
