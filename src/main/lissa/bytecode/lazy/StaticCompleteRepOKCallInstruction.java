...
public class StaticCompleteRepOKCallInstruction extends JVMInvokeInstruction {

    ClassInfo ci;
    Instruction next;
    RepokCallWithLazyInitCG repOKCG;

    public StaticCompleteRepOKCallInstruction(String clsName, String methodName, String methodSignature) {
        super(clsName, methodName, methodSignature);
    }

    public void initialize(Instruction current, Instruction next, RepokCallWithLazyInitCG repOKCG) {
    ...
    public Instruction typeSafeClone(MethodInfo mi) {
        StaticCompleteRepOKCallInstruction clone = null;

        try {
            clone = (StaticCompleteRepOKCallInstruction) super.clone();
