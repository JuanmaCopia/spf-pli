...
public class STATICREPOK extends JVMInvokeInstruction {

    ClassInfo ci;

    public STATICREPOK(String clsName, String methodName, String methodSignature) {
    ...
    public Instruction typeSafeClone(MethodInfo mi) {
        STATICREPOK clone = null;

        try {
            clone = (STATICREPOK) super.clone();
