...
public class SymbolicStringHandler {
    ...
    public boolean isMethodStringSymbolic(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if (cname.equals("java.lang.String") || cname.equals("java.lang.StringBuilder")
                || cname.equals("java.lang.StringBuffer") || cname.equals("java.lang.CharSequence")
                || cname.equals("java.lang.Appendable") || cname.equals("java.io.PrintStream")
                || cname.equals("java.lang.Integer") || cname.equals("java.lang.Float")
                || cname.equals("java.lang.Double") || cname.equals("java.lang.Long") || cname.equals("java.lang.Short")
                || cname.equals("java.lang.Byte") || cname.equals("java.lang.Char") || cname.equals("java.lang.Boolean")
    ...
    public void handleLastIndexOf1(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if (sym_v1 == null && sym_v2 == null) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: HandleLastIndexOf1");
        } else {
    ...
    public void handleLastIndexOf2(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if (sym_v1 == null && sym_v2 == null && intExp == null) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: HandleLastIndexOf2");
        } else {
            int i1 = sf.pop();
            boolean s2char = true;
    ...
    public void handlebooleanValue(JVMInvokeInstruction invInst, SystemState ss, ThreadInfo th) {
        ...
        if (sym_v3 == null) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: HandlebooleanValue");
        } else {
    ...
    public Instruction handleInit(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if (cname.equals("java.lang.StringBuilder") || cname.equals("java.lang.StringBuffer")) {
            ...
            if (sym_v1 == null) {
                throw new RuntimeException(
                        "ERROR: symbolic StringBuilder method must have one symbolic operand in Init");
            } else {
            ...
            // Corina TODO: we should allow symbolic string analysis to kick in only when
            // desired
            // throw new RuntimeException("Warning Symbolic String Analysis: Initialization
            // type not handled in symbc/bytecode/SymbolicStringHandler init");
            return null;
        }
    }
    ...
    private void handleBooleanStringInstructions(JVMInvokeInstruction invInst, ThreadInfo th, StringComparator comp) {
        ...
        if ((sym_v1 == null) & (sym_v2 == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: HandleStartsWith");
        } else {
            ChoiceGenerator<?> cg;
    ...
    public void handleEndsWith(JVMInvokeInstruction invInst, ThreadInfo th) {
        // throw new RuntimeException("ERROR: symbolic string method not Implemented -
        // EndsWith");
    ...
    public Instruction handleSubString1(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2 == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: HandleSubString1");
        } else {
            int s1 = sf.pop();
            int s2 = sf.pop();
    ...
    public Instruction handleSubString2(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2 == null) & (sym_v3 == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: HandleSubString2");
        } else {
            int s1 = sf.pop();
            int s2 = sf.pop();
            int s3 = sf.pop();
            ...
            if (sym_v1 == null) { // operand 0 is concrete
                ...
                if (sym_v2 == null) { // sym_v3 has to be symbolic
                    ...
                    /*
                     * Only if both arguments are concrete, something else needs to be pushed?
                     */
    ...
    public Instruction handleReplaceFirst(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2 == null) & (sym_v3 == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: HanldeReplaceFirst");
        } else {
            int s1 = sf.pop();
            int s2 = sf.pop();
            int s3 = sf.pop();
    ...
    public Instruction handleBooleanValueOf(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if (sym_v1 == null) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have symbolic operand: handleBooleanValueOf");
        } else {
            sf.pop();
            StringExpression sym_v2 = StringExpression._valueOf(sym_v1);
            int objRef = th.getHeap().newString("", th).getObjectRef(); /*
    ...
    public Instruction handleAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if (argTypes[0].equals("java.lang.CharSequence")) {
            ...
            if (firstParam instanceof StringExpression || firstParam == null /* possibly an string constant */) {
                ...
                throw new RuntimeException(
                        "Unhandled CharSequence at Symbolic String Append; concrete type is:" + firstParam.getClass());
            }
        }
    ...
    public void handleStringAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: handleStringAppend");
        } else {
            int s1 = sf.pop();
            int s2 = sf.pop();
    ...
    public Instruction handleStringAppend3(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if (concreteSubstring & sym_builder.getstr() == null) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: HandleStringAppend3");
        } else {
            int endRef = sf.pop();
            int startRef = sf.pop();
    ...
    // helper
    private StringExpression createSymbolicSubstring(StringExpression sym_str, IntegerExpression sym_start,
            IntegerExpression sym_end, int startRef, int endRef) {
    ...
    public void setVariableAttribute(ElementInfo ei, JVMInvokeInstruction invInst, ThreadInfo th, StackFrame sf,
            int idx, Object sym_v2) {
    ...
    public void handleCharAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: handleCharAppend");
        } else {
            char s1 = (char) sf.pop();
            int s2 = sf.pop();
            if (sym_v1 == null) { // operand 0 is concrete
    ...
    public void handleByteAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: handleByteAppend");
        } else {
            byte s1 = (byte) sf.pop();
            int s2 = sf.pop();
            if (sym_v1 == null) { // operand 0 is concrete
    ...
    public void handleShortAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: handleShortAppend");
        } else {
    ...
    public void handleFloatAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: hanldeFloatAppend");
        } else {
    ...
    public void handleBooleanAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: hanldeBooleanAppend");
        } else {
    ...
    public void handleLongAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) & (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: handleLongAppend");
        } else {
            long s1 = sf.popLong();
            int s2 = sf.pop();
            if (sym_v1 == null) { // operand 0 is concrete
    ...
    public void handleObjectAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1 == null) && (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: handleObjectAppend");
        } else {
            int s1 = sf.pop();
            ElementInfo e2 = th.getElementInfo(s1);
            int s2 = sf.pop();
            if (sym_v1 == null
                    || (sym_v1 instanceof SymbolicStringBuilder && ((SymbolicStringBuilder) sym_v1).getstr() == null)) { // operand
                                                                                                                         // 0
                                                                                                                         // is
                                                                                                                         // concrete
    ...
    public void handleStringBuilderAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if ((sym_v1.getstr() == null) & (sym_v2.getstr() == null)) {
            throw new RuntimeException(
                    "ERROR: symbolic string method must have one symbolic operand: hanldeStringBuilderAppend");
        } else {
            int s1 = sf.pop();
            int s2 = sf.pop();
