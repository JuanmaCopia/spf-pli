...
public class InvokeStaticInstruction extends JVMInvokeInstruction {

    ClassInfo ci;

    public InvokeStaticInstruction(String clsName, String methodName, String methodSignature,
            Instruction currentInstruction) {
        super(clsName, methodName, methodSignature);
        setMethodInfo(currentInstruction.getMethodInfo());
        setLocation(currentInstruction.getInstructionIndex(), currentInstruction.getPosition());
    }
    ...
    public Instruction typeSafeClone(MethodInfo mi) {
        InvokeStaticInstruction clone = null;

        try {
            clone = (InvokeStaticInstruction) super.clone();
