...
public class X2ProcedureCallInstruction extends JVMInvokeInstruction {
    ...
    public X2ProcedureCallInstruction(MethodInfo mi, Instruction current, Instruction next, XCG xcg) {
    ...
    public Instruction typeSafeClone(MethodInfo mi) {
        X2ProcedureCallInstruction clone = null;

        try {
            clone = (X2ProcedureCallInstruction) super.clone();
