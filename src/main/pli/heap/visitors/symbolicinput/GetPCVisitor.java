...
public class GetPCVisitor implements HeapVisitor {
    ...
    PathCondition accessedPathCondition;

    public GetPCVisitor(StateSpace stateSpace, SymSolveSolution solution) {
        vm = VM.getVM();
        JPFHeap = vm.getHeap();
        ...
        accessedPathCondition = new PathCondition();
    }
    ...
    public void visitedSymbolicPrimitiveField(Expression symbolicPrimitive) {
        ...
        if (accessedIndices.contains(indexInVector)) {
            ...
            if (clsOfField == int.class) {
                ...
                accessedPathCondition._addDet(Comparator.EQ, symbolicPrimitive, constant);
    ...
    public PathCondition getPathConditionOfAccessedFields() {
    	return accessedPathCondition;
    }
